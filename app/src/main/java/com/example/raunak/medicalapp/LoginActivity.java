...
public void guest(View v)
{
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            String restUrl="http://medicalapp.pe.hu/login.php";
            try
            {
                String data= URLEncoder.encode("email","UTF-8")+"="+URLEncoder.encode(mEmail,"UTF-8");
                data+="&"+URLEncoder.encode("pass","UTF-8")+"="+URLEncoder.encode(mPassword,"UTF-8");
    ...
    {
        Intent in=new Intent(this,CreateAcc.class);
        startActivity(in);
    }
}
